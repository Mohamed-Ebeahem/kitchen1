...
let myInner = document.getElementById("myInner");
...
function showContacts() {
    ...
    <div class="container w-75 text-center">
        ...
        <button id="myButt" disabled class="btn btn-outline-danger px-2 mt-3">Submit</button>
    </div>
</div> `
myButt = document.getElementById("myButt")
...
function inputsValidation() {
    ...
    if (nameValidation() &&
        ...
        repasswordValidation()) {
            myButt.removeAttribute("disabled")
    } else {
